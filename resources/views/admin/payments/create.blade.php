    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.payments.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('payment_for_month') ? 'is-invalid' : '' }}" type="text" name="payment_for_month" id="payment_for_month" value="{{ old('payment_for_month') }}" required>
